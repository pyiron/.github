...
| [pyiron_base](https://github.com/pyiron/pyiron_base)                         | A package for the core components e.g. the job management, data storage and resource management.         |     [:package:](https://anaconda.org/conda-forge/pyiron_base)     |
...
| [pyiron_contrib](https://github.com/pyiron/pyiron_contrib)                   | A package to collect contributions from the community and/or bleeding edge developments.                                                      |   [:package:](https://anaconda.org/conda-forge/pyiron_contrib)    |
